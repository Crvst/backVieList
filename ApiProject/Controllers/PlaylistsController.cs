...
namespace ApiProject.Controllers
{
    public class PlaylistsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Id_Usuario,Playlist_Url")] Playlist playlist)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Id_Usuario,Playlist_Url")] Playlist playlist)
        {
            if (id != playlist.Id)
            {
                return NotFound();
